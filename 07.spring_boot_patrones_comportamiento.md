...
### 🧠 PaymentService y PaymentServiceImpl: Cliente del patrón Strategy

En el contexto del `patrón Strategy`, el cliente es quien solicita que se aplique una estrategia en particular, sin
saber cómo funciona internamente. En este diseño, `PaymentServiceImpl` cumple ese rol, permitiendo que la lógica de
