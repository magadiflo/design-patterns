...
📌 Ejemplos clásicos: `Adapter`, `Proxy`, etc.
...
### RealSubject: `ProductServiceImpl`

La clase `ProductServiceImpl` es la implementación real de la interfaz `ProductService`. En el `patrón Proxy`, este
componente representa al `RealSubject`, el cual contiene la lógica de negocio "pesada" o costosa que el Proxy intenta
optimizar mediante almacenamiento en caché.
...
- Es el `RealSubject`: contiene la lógica original y completa de acceso a datos.
- El `Proxy` delega a esta clase únicamente cuando no puede resolver la solicitud desde la caché.
- Sin el `Proxy`, el cliente tendría que pagar siempre el costo de la consulta simulada (3 segundos).

### Proxy: `ProductServiceCacheProxy`

La clase `ProductServiceCacheProxy` implementa la interfaz `ProductService`, pero añade una capa intermedia de
almacenamiento en caché siguiendo el `patrón Proxy`.

Su propósito es interceptar las solicitudes del cliente y decidir si devolver el resultado desde la caché (`cache hit`)
o delegar la consulta al servicio real (`cache miss`).
...
- Este componente es el `Proxy`: controla el acceso al `RealSubject` (`ProductServiceImpl`).
- Intercepta todas las llamadas y decide si ejecuta directamente o delega.
- Añade un comportamiento adicional (caché inteligente) sin modificar la lógica original.

### Cliente: `Client`

La clase `Client` representa al consumidor del servicio. En el contexto del `patrón Proxy`, el cliente es completamente
transparente respecto a si interactúa con el `RealSubject` (`ProductServiceImpl`) o con el `Proxy`
`(ProductServiceCacheProxy`).

De esta manera se demuestra que el `Proxy` puede añadir funcionalidad adicional (caché inteligente) sin que el cliente
deba cambiar su código.
...
````bash
23:08:46.115 [main] INFO ...proxy.cache.Client -- Primera llamada (Cache MISS)
23:08:46.125 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Cache MISS. Consultando el servicio real
23:08:46.125 [main] INFO ...proxy.cache.realsubject.ProductServiceImpl -- Ejecutando consulta cara por categoría...
23:08:49.139 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Resultado guardado en caché. Tiempo total: 3014 ms
23:08:49.140 [main] INFO ...proxy.cache.Client -- Productos encontrados: 5
23:08:49.140 [main] INFO ...proxy.cache.Client -- Segunda llamada inmediata (Cache HIT):
23:08:49.140 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Cache HIT. Datos recuperados desde caché en 0 ms
23:08:49.141 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Datos almacenados en caché desde: 2025-09-28T23:08:49.139158400
23:08:49.141 [main] INFO ...proxy.cache.Client -- Productos encontrados: 5
23:08:49.141 [main] INFO ...proxy.cache.Client -- 
23:08:49.141 [main] INFO ...proxy.cache.Client -- Productos Relacionados (Cache MISS)
23:08:49.141 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Cache MISS. Consultando el servicio real
23:08:49.141 [main] INFO ...proxy.cache.realsubject.ProductServiceImpl -- Ejecutando consulta cara para productos relacionados...
23:08:52.154 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Resultado guardado en caché. Tiempo total: 3013 ms
23:08:52.154 [main] INFO ...proxy.cache.Client -- Productos relacionados: 1
23:08:52.154 [main] INFO ...proxy.cache.Client -- Mismos Productos Relacionados (Cache HIT)
23:08:52.154 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Cache HIT. Datos recuperados desde caché en 0 ms
23:08:52.154 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Datos almacenados en caché desde: 2025-09-28T23:08:52.154235600
23:08:52.154 [main] INFO ...proxy.cache.Client -- Productos relacionados: 1
23:08:52.154 [main] INFO ...proxy.cache.Client -- 
23:08:52.155 [main] INFO ...proxy.cache.Client -- Búsqueda con filtros (Cache MISS)
23:08:52.157 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Cache MISS. Consultando el servicio real
23:08:52.157 [main] INFO ...proxy.cache.realsubject.ProductServiceImpl -- Ejecutando consulta cara con múltiples filtros...
23:08:55.162 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Resultado guardado en caché. Tiempo total: 3005 ms
23:08:55.162 [main] INFO ...proxy.cache.Client -- Productos filtrados: 3
23:08:55.162 [main] INFO ...proxy.cache.Client -- Búsqueda con filtros (Cache HIT)
23:08:55.162 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Cache HIT. Datos recuperados desde caché en 0 ms
23:08:55.162 [main] INFO ...proxy.cache.proxy.ProductServiceCacheProxy -- Datos almacenados en caché desde: 2025-09-28T23:08:55.162188
23:08:55.162 [main] INFO ...proxy.cache.Client -- Productos filtrados: 3
````

Rol dentro del Patrón Proxy

- El `Client` desconoce si interactúa con el `RealSubject` o con el `Proxy`.
- El contrato común (`ProductService`) asegura la transparencia.
- Lo que cambia es el comportamiento interno: con el `Proxy` se evita ejecutar siempre las consultas costosas.
